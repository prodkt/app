...
const errorCodeMessages: {
  ...
  [EAuthenticationErrorCodes.USER_ACCOUNT_DEACTIVATED]: {
    ...
    message: () => <div>Your account is deactivated. Contact support@prodkt.cloud.</div>,
  },
  ...
  [EAuthenticationErrorCodes.ADMIN_USER_ALREADY_EXIST]: {
    ...
    message: () => (
      <div>
        ...
        <a className="underline underline-offset-4 font-medium hover:font-bold transition-all" href={`/admin`}>
          Sign In
        </a>
        &nbsp;now.
      </div>
