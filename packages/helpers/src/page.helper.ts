 ...
 * @returns {TPage[]}
 */
export const filterPagesByPageType = (
 ...
 * @returns {boolean}
 */
export const shouldFilterPage = (
  page: TPage,
  filters: TPageFilterProps | undefined,
): boolean => {
  ...
  Object.keys(filters ?? {}).forEach((key) => {
    ...
    if (
      ...
      fallsInFilters =
        fallsInFilters && filters.created_by.includes(`${page.created_by}`)
    if (
