          ...
          <div className='mx-auto max-w-4xl pb-36 pt-28'>
            <div className='-m-3 flex flex-wrap'>
              <div className='w-full p-3 md:w-1/2'>
                <div className='bg-radial-gradient from-gray-4 to-gray-1 relative flex h-auto flex-col items-stretch gap-4 overflow-hidden border border-[var(--grayA3)] p-10'>
                  ...
                  <div className='z-[1] flex h-full grow flex-wrap items-stretch justify-stretch'>
                    <div className='z-[1] size-full'>
                      ...
                      <div className=' inset-0 my-0 size-full flex-col place-content-start place-items-start content-start items-stretch justify-start '>
                        {/* START TOP ROW */}
                        <div className=' flex size-full flex-col place-content-stretch place-items-stretch content-stretch items-stretch justify-stretch overflow-hidden rounded-t-2xl border border-dashed border-[var(--grayA4)] border-b-[var(--grayA6)] bg-gradient-to-b from-[var(--ghost-aa9)] to-[var(--ghost-aa1)] backdrop-blur-sm'>
                          {/* START TOP ROW - ROW 1 */}
                          <div className='absolute mx-0 mb-auto flex h-auto w-full flex-row items-center justify-between'>
                            ...
                            <div className='flex w-1/2 flex-row items-center justify-end pr-2'>
                              {/* START AVATARBOX */}
                              <div className='from-gray-1 via-gray-2 to-grayA-4 flex size-8 flex-col items-center justify-center gap-0 rounded-lg bg-gradient-to-tr shadow-[inset_0px_-2px_6px_var(--grayA4)]'></div>
                        ...
                        <div className='mt-auto h-0 max-h-0 w-full overflow-visible bg-gradient-to-b from-[var(--ghost-aa6)] to-[var(--ghost-aa1)] backdrop-blur-sm'>
                          <div className=' absolute left-[calc(75%-2rem)] size-16 -translate-y-1/2 border border-dashed border-[var(--grayA4)] bg-[var(--grayA2)] p-1 backdrop-blur '>
                            <div className='flex size-full items-center justify-center border-[var(--grayA4)] bg-[var(--grayA2)]'>
                              +
                            </div>
                            <div className='absolute -left-1 -top-1 size-2 border border-[var(--gray5)]'></div>
                            <div className='absolute -bottom-1 -left-1 size-2 border border-[var(--gray5)]'></div>
                            <div className='absolute -right-1 -top-1 size-2 border border-[var(--gray5)]'></div>
                            <div className='absolute -bottom-1 -right-1 size-2 border border-[var(--gray5)]'></div>
                          </div>
                        </div>
                        <div className=' gradientMask-to-t absolute right-[calc(25%+1.2rem)] top-0 h-full min-h-full w-0 max-w-0 self-stretch border border-dashed border-[var(--grayA4)]' />
                        {/* START BOTTOM ROW */}
                        <div className='mt-auto flex h-auto w-full flex-col items-start justify-center gap-4 rounded-b-2xl border border-t-0 border-[var(--grayA4)] bg-gradient-to-b from-[var(--ghost-aa6)] to-[var(--ghost-aa1)] px-8 pb-8 pt-20'>
                  ...
                  <div className='bottom-0 top-auto z-[1] mb-0 mt-auto flex size-auto w-full flex-row gap-4 p-2'>
                    <a
                      href='/codeblocks'
                      className='bg-radial-gradient from-gray-12 hover:to-gray-9 to-gray-6 text-nowrap bg-clip-text pb-1 text-xs font-semibold tracking-tight text-transparent underline decoration-[var(--grayA6)] underline-offset-4 transition-colors duration-500 ease-in'
                    >
                      View Codeblocks
                    </a>
              ...
              <div className='w-full p-3 md:w-1/2'>
                <div className='to-grayA-1 h-full overflow-hidden border border-[var(--grayA4)] bg-gradient-to-b from-[var(--grayA2)] p-8'>
                  <div className='bottom-0 top-auto z-[1] mb-10 mt-auto flex size-auto flex-col gap-0 p-2'>
                    <h3 className='from-gray-12 via-gray-11 to-gray-1 gradientMask-to-t-10 max-w-xs text-balance bg-gradient-to-t bg-clip-text pb-2 text-3xl font-semibold leading-10 tracking-tighter text-transparent'>
                      Astro SSR Turborepo
                    </h3>
                  ...
                  <div className='relative'>
                    ...
                    <GithubCat className='pointer-events-none select-none mix-blend-overlay' />
                    ...
                    <GlowOrb className='pointer-events-none absolute -left-1/4 -top-1/4 z-0 m-auto scale-[2] select-none mix-blend-hard-light brightness-100 contrast-50' />
                  ...
                  <div className='z-[1] mb-0 mt-auto flex grow flex-col items-stretch justify-stretch gap-4 p-2'>
                    <h3 className='bg-radial-gradient from-gray-12 to-gray-6 h-full max-w-[75%] text-balance bg-clip-text pb-1 text-xl font-semibold leading-6 tracking-tighter text-transparent'>
              ...
              <div className='w-full p-3 md:w-1/2'>
                <div className='bg-conic-gradient relative h-full overflow-hidden border border-[var(--greenA3)] from-[var(--oliveA2)] to-[var(--olive1)] p-16'>
                  ...
                  <div className='bottom-0 top-auto z-[1] mb-10 mt-auto flex size-auto flex-col gap-12 p-2'>
                    ...
                    <p className='text-shadow-[0_0_20px_var(--grayA9)] text-md mx-auto bg-gradient-to-b from-[var(--grayA4)] to-[var(--grayA11)] bg-clip-text pl-1 font-mono uppercase tracking-[0.36rem] text-transparent'>
                      DB + CMS + Docker
                    </p>
                  </div>
                  <div className='relative inset-0 mx-auto -mb-24 -ml-11 mt-24 h-auto w-full'>
                    ...
                    <DataCube className=' inset-0 mx-auto origin-center mix-blend-color-burn' />
                  </div>
              ...
              <div className='w-full p-3 md:w-1/2'>
                <div className='relative h-full overflow-hidden border border-[var(--grayA4)] bg-gradient-to-b from-[var(--gray1)] to-[var(--gray1)]'>
                  <div className='0 bottom-0 top-auto z-[1] m-0 flex size-auto h-full flex-col gap-8 p-10'>
                    ...
                    <h3 className='from-gray-10 to-gray-8 text-md h-full max-w-[75%] text-balance bg-gradient-to-br bg-clip-text pb-1 font-semibold leading-6 tracking-tight  text-transparent'>
                    ...
                    <div className=' bottom-0 mb-0 h-fit max-h-fit w-full'>
                      ...
                      <Signature className='inset-x-0 z-0 mx-auto mt-auto h-auto max-w-56 -translate-x-16 translate-y-4 rotate-6 -skew-y-12 skew-x-12 scale-x-105 fill-transparent stroke-[var(--grayA10)] stroke-1  text-[var(--grayA3)]  brightness-0 contrast-50' />
                    </div>
                  </div>
                  ...
                  <img
                    src={Portrait}
                    alt=''
                    className='gradientMask-to-t-50 absolute inset-y-0 my-auto translate-y-1/4 opacity-50 mix-blend-difference brightness-50 contrast-[0.81]'
                  />
                </div>
              </div>
            </div>
