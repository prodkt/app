        ...
        <div className='container mx-auto px-4'>
          <div className='mx-auto max-w-4xl pb-16 pt-4 md:pt-8 lg:pb-24 lg:pt-16'>
            <div className='-m-3 flex flex-wrap'>
                    ...
                    <div className='z-[1] size-full'>
                      ...
                      <div className=' inset-0 my-0 size-full flex-col place-content-start place-items-start content-start items-stretch justify-start '>
                        ...
                        <div className=' flex size-full flex-col place-content-stretch place-items-stretch content-stretch items-stretch justify-stretch overflow-hidden rounded-t-2xl border border-dashed border-[var(--gray8)] border-b-[var(--gray8)] bg-gradient-to-b from-[var(--ghost-aa9)] to-[var(--ghost-a2)] backdrop-blur-sm dark:to-[var(--ghost-aa1)]'>
                          ...
                          {/* END TOP ROW - ROW 1 */}
                          {/* START TOP ROW - ROW 2 */}
                          <div className='inset-0 m-0 flex size-full min-h-80 flex-row items-center justify-center self-stretch '>
                            <ChartBar />
                          </div>
                          {/* END TOP ROW - ROW 2 */}
                        </div>
              ...
              <div className='w-full p-3 md:w-1/2'>
                <div className='bg-conic-gradient relative h-full overflow-hidden border border-[var(--greenA3)]  from-[var(--oliveA7)] to-[var(--olive7)] p-6 ring ring-inset ring-[var(--grayA3)] md:p-16 dark:from-[var(--olive1)]'>
                  ...
                  <div className='bottom-0 top-auto z-[1] mb-10 mt-auto flex h-auto w-full flex-col gap-12 p-2'>
                    ...
                    <p className='text-md text-shadow-[0_0_20px_var(--grayA9)] mx-0 w-full bg-gradient-to-b from-[var(--grayA4)] to-[var(--grayA11)] bg-clip-text pl-1 text-center font-mono uppercase tracking-[0.36rem] text-transparent'>
                      DB + CMS + Docker
                    </p>
                  </div>
              ...
              <div className='w-full p-3 md:w-1/2'>
                <div className='relative h-full overflow-hidden border border-[var(--grayA4)]  bg-gradient-to-b from-[var(--gray4)] ring ring-inset ring-[var(--grayA3)] dark:from-[var(--ghost-aa8)]'>
                  <div className='0 bottom-0 top-auto z-[1] m-0 flex size-auto h-full flex-col gap-8 p-10'>
                    <p className='text-shadow-[0_0_20px_var(--grayA9)] text-balance bg-gradient-to-b from-[var(--grayA9)] to-[var(--grayA11)] bg-clip-text pl-1 font-mono text-xs uppercase tracking-[0.15rem] text-transparent'>
                      <em className='not-italic text-[var(--amber9)]'>
                        Hiring
                      </em>{' '}
                      or know someone that is?
                    </p>
                    <h3 className='from-gray-12 to-gray-10 max-w-xs text-balance bg-gradient-to-b bg-clip-text pb-2 text-4xl font-medium leading-8 tracking-tighter text-transparent'>
                      {`I'm`} on the search for my next challenge.
                    </h3>
                    <h3 className='text-md text-gray-9 h-full max-w-[75%]  text-balance pb-1.5 leading-6 tracking-tight'>
                  ...
                  <img
                    src={Portrait}
                    alt=''
                    className='gradientMask-to-t-50 pointer-events-none absolute inset-y-0 my-auto translate-y-1/4 select-none opacity-25 mix-blend-difference contrast-125 invert md:opacity-50 dark:brightness-50 dark:contrast-[0.81] dark:invert-0'
                  />
                </div>
              </div>
            </div>
