...
const Olio: React.FC = (props) => (
  <section
    className='relative flex w-full flex-col items-center justify-center overflow-hidden p-12 align-middle'
    {...props}
  >
    <img
      src={Background2}
    ...
    <div className='container relative z-[5] mx-auto px-4'>
      <div className='mx-auto flex max-w-4xl flex-col items-center justify-start text-center'>
        ...
        >
          <img
            ...
            loading='lazy'
            alt='prodkt'
            className='pointer-events-none mx-auto mb-4 h-auto w-32 select-none sm:w-40'
          />
          ...
          <a
            ...
            href='/'
          >
            <div className='absolute left-px right-full top-0 mr-px size-full rounded-3xl bg-gradient-to-tr from-[var(--blue10)] to-[#4345fd] p-px blur-lg transition duration-500 group-hover:translate-x-[70%] group-hover:scale-[1.2]' />
