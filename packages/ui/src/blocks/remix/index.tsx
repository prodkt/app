...
const Remix = React.forwardRef<HTMLDivElement>(({ ...props }, ref) => {
  return (
    <section
      ref={ref}
      className='relative w-full pb-20 overflow-hidden xl:pb-32'
      {...props}
    >
      <div className='absolute bottom-0 top-auto z-10 mb-0 mt-auto h-[120px] w-full bg-gradient-to-b from-transparent to-[var(--violet1)]'></div>
      ...
      <img
        ...
        loading='lazy'
        alt='prodkt blog'
        className='absolute top-0 left-0 object-cover object-top pointer-events-none select-none size-full blur-lg'
      />
      <img
        src={BlogImageFour}
        decoding='async'
        loading='lazy'
        alt='prodkt blog'
        className='absolute top-0 left-0 object-cover object-top pointer-events-none select-none size-full opacity-20'
      />
      <div className='relative mx-auto mt-[90px] md:mt-[100px] lg:mt-[130px]'>
        <div className='mx-auto max-w-[1200px]'>
          <div className='flex flex-col flex-wrap items-center justify-center w-full gap-0 align-top md:flex-row md:flex-nowrap md:gap-8'>
            <div className='flex flex-col items-center justify-start flex-initial align-top shrink grow basis-1/3'>
              <h1 className='flex flex-row font-bold tracking-tighter remix-heading flex-nowrap whitespace-nowrap text-nowrap'>
                <span className='pl-0 ml-0 typed-element flex-nowrap whitespace-nowrap text-nowrap text-inherit'>
                  Remix
                </span>
              </h1>
              <a
                ...
                href='/'
              >
                <div className='absolute left-px right-full top-0 mr-px size-full rounded-3xl bg-gradient-to-tr from-[var(--crimsonA9)] to-[var(--violetA6)] p-px blur-lg transition duration-500 group-hover:translate-x-[70%] group-hover:scale-[1.2]'></div>
            ...
            <div className='relative z-0 flex flex-col items-center justify-center flex-initial text-center align-middle origin-top-left grow basis-1/3 place-content-center place-items-center'>
              <img
                src={Decorative2}
                decoding='async'
                loading='lazy'
                alt='prodkt remix lxp'
                className='pointer-events-none absolute top-0 z-0 min-w-min origin-center -translate-x-[28%] -translate-y-20 select-none blur-lg'
              />
              <div className='relative left-0 z-[5] flex w-auto origin-top-left flex-col place-content-center place-items-center items-center justify-center p-12'>
                ...
                <div className='mx-auto h-[459px] max-h-[459px] max-w-[213px] overflow-hidden rounded-[27px] bg-[var(--ghost-aa10)] p-0'>
                  ...
                  <img
                    ...
                    loading='lazy'
                    alt='prodkt remix lxp'
                    className='absolute right-0 top-0 mx-auto origin-center -translate-y-[60px] translate-x-[120px] scale-50 overflow-hidden object-contain'
                  />
                  <img
                    src={RemixElement_3}
                    decoding='async'
